  ...
  return (
    <Nav>
      <NavbarContainer>
        <NavLogo to='/'>
          <Span>
            <span style={{ color: '#8C48F0', fontWeight: '300', fontSize: '1.8rem' }}>{"</"}</span>
            <span style={{ color: 'white', fontWeight: 'semibold', fontSize: '2rem' }}>Portfolio</span>
            <span style={{ color: '#8C48F0', fontWeight: '300', fontSize: '1.8rem' }}>{">"}</span>
          </Span>
        </NavLogo>
        ...
        </ButtonContainer>
        {
          ...
          <MobileMenu isOpen={isOpen}>
            <MobileNavLogo to='/'>
              <Span>
                <span style={{ color: '#8C48F0', fontWeight: '300' }}>{"</"}</span>
                <span style={{ color: 'white', fontWeight: 'bold' }}>Pravin</span>
                <span style={{ color: '#8C48F0', fontWeight: '300' }}>{">"}</span>
              </Span>
            </MobileNavLogo>
